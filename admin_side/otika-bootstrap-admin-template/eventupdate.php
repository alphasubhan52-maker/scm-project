...
$uid = $_GET['id'];
$gsql = "SELECT*FROM `event` WHERE `eventid`='$uid'";
...
if (isset($_POST['submit'])) {
  ...
  if ($msg == "Right") {
    ...
    $sql = "UPDATE `event` SET `category`='$category',`title`='$title',`date`='$date',`images`='$im',`eventdescription`='$description' WHERE `eventid`='$uid'";
    ...
    $old = $gfet['images'];
    $sql2 = "UPDATE `event` SET `category`='$category',`title`='$title',`date`='$date',`images`='$old',`eventdescription`='$description' WHERE `eventid`='$uid'";
        ...
        <div class="row justify-content-center">
          ...
          <div class="card w-75">
            ...
            <div class="form-group">
              ...
              <input type="date" class="form-control" id="date" name="date" value="<?php echo $gfet['date'] ?>">
            </div>
            <div class="form-group">
            ...
            <div class="form-group">
              ...
              <textarea type="text" class="form-control" id="description" name="description">
                       <?php echo $gfet['eventdescription'] ?></textarea>
            </div>
