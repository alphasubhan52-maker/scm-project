              ...
              <div class="col-sm-12 ">
                <div class="card">
                  <div class="card-header row">
                    <div>
                    <h1 style="font-family:sans-serif;color:black;">View Volunteer</h1>
                ...
                <td>
                <a href="volunteerupdate.php?id=<?php echo $fet['id']?>" class="btn btn-primary my-2">Update</a>
                <a href="volunteerdelete.php?id=<?php echo $fet['id']?>" class="btn btn-danger my-2">Delete</a>
