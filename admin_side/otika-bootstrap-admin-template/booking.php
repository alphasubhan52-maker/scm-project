          ...
          <div class="card w-75">
            ...
            <div class="row">
              <div class="form-group col-4">
                ...
                <select class="form-control" name="country" id="country" class="city">
              ...
              <div class="form-group col-4">
                ...
                <select class="form-control" name="state" id="state" class="city">
              ...
              <div class="form-group col-4">
                ...
                <select class="form-control" name="city" id="city" class="city">
