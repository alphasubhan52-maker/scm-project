          ...
          <div class="section-body">
            <div class="row justify-content-center">
              <div class="col-12 col-md-8 col-lg-8">
                ...
                <td>
                <a href="cityupdate.php?id=<?php echo $fet['id']?>" class="btn btn-primary my-2">Update</a>
                <a href="citydelete.php?id=<?php echo $fet['id']?>" class="btn btn-danger my-2">Delete</a>
