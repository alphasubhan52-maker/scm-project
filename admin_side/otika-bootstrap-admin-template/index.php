                ...
                <div class="row ">
                  ...
                  <div class="col-lg-6 col-md-6 col-sm-6 col-xs-6 pr-0 pt-3">
                    <div class="card-content">
                      <h5 class="font-15">Planner</h5>
                      <?php
                      $sql = "SELECT COUNT(*) AS total FROM `planner`";
                      $run = mysqli_query($conn, $sql);
                      if ($run) {
                        $fet = mysqli_fetch_assoc($run);
                        $total = (int)$fet['total'];
                  ...
                  <div class="col-lg-6 col-md-6 col-sm-6 col-xs-6 pl-0">
                    <div class="banner-img">
                      <img src="./New folder/Screenshot_32.png" alt="">
                    </div>
                  </div>
                </div>
              </div>
            ...
            <div class="card-statistic-4">
              <div class="align-items-center justify-content-between">
                <div class="row ">
                  <div class="col-lg-6 col-md-6 col-sm-6 col-xs-6 pr-0 pt-3">
                    <div class="card-content">
                      <h5 class="font-15">Designer</h5>
                      <?php
                      $sql = "SELECT COUNT(*) AS total FROM `designer`";
                      $run = mysqli_query($conn, $sql);
                      if ($run) {
                        $fet = mysqli_fetch_assoc($run);
                        $total = (int)$fet['total'];
                  ...
                  <div class="col-lg-6 col-md-6 col-sm-6 col-xs-6 pl-0">
                    <div class="banner-img">
                      <img src="./New folder/Screenshot_34.png" alt="">
                    </div>
                  </div>
                </div>
            ...
            <div class="card-statistic-4">
              <div class="align-items-center justify-content-between">
                ...
                <div class="row ">
                  ...
                  <div class="col-lg-6 col-md-6 col-sm-6 col-xs-6 pl-0">
                    <div class="banner-img">
                      <img src="./New folder/Screenshot_37.png" alt="">
                    </div>
                  </div>
                </div>
              </div>
          ...
          <div class="card-statistic-4">
            <div class="align-items-center justify-content-between">
              <div class="row ">
                <div class="col-lg-6 col-md-6 col-sm-6 col-xs-6 pr-0 pt-3">
                  <div class="card-content">
                    <h5 class="font-15">Venue</h5>
                    <?php
                    $sql = "SELECT COUNT(*) AS total FROM `venue`";
                    $run = mysqli_query($conn, $sql);
                    if ($run) {
                      $fet = mysqli_fetch_assoc($run);
                      $total = (int)$fet['total'];
                ...
                <div class="col-lg-6 col-md-6 col-sm-6 col-xs-6 pl-0">
                  <div class="banner-img">
                    <img src="./New folder/Screenshot_36.png" alt="">
                  </div>
                </div>
              </div>
            </div>
          ...
          <div class="card-statistic-4">
            <div class="align-items-center justify-content-between">
              <div class="row ">
                ...
                <div class="col-lg-6 col-md-6 col-sm-6 col-xs-6 pl-0">
                  <div class="banner-img">
                    <img src="./New folder/Screenshot_35.png" alt="">
                  </div>
                </div>
              </div>
            </div>
          ...
          <div class="card-statistic-4">
            <div class="align-items-center justify-content-between">
              <div class="row ">
                ...
                <div class="col-lg-6 col-md-6 col-sm-6 col-xs-6 pl-0">
                  <div class="banner-img">
                    <img src="./New folder/Screenshot_33.png" alt="">
                  </div>
                </div>
              </div>
            </div>
          ...
          <div class="card-statistic-4">
            <div class="align-items-center justify-content-between">
              <div class="row ">
                <div class="col-lg-6 col-md-6 col-sm-6 col-xs-6 pr-0 pt-3">
                  <div class="card-content">
                    <h5 class="font-15">Recent Booking</h5>
                    <?php
                    if ($roleaccess == "all") {
                      $sql = "SELECT COUNT(*) AS total FROM `userbooking`";
                      $run = mysqli_query($conn, $sql);
                      if ($run) {
                        $fet = mysqli_fetch_assoc($run);
                        $total = (int)$fet['total'];
                      ...
                      $sql = "SELECT COUNT(*) AS total FROM `userbooking` WHERE `workeremail`='$email'";
                      $run = mysqli_query($conn, $sql);
                      if ($run) {
                        $fet = mysqli_fetch_assoc($run);
                        $total = (int)$fet['total'];
