...
$uid = $_GET['id'];
$sql = "SELECT*FROM `planner` INNER JOIN `experience` ON planner.experience=experience.expid WHERE `id`='$uid'";
...
<section id="main-container" class="main-container">
    <div class="container">
        <div class="row">
            ...
            <div class="col-lg-8 col-md-8 col-sm-12 mx-auto h-auto">
                <div class="post">
                    <div class="post-media post-image col-10">
                    ...
                    <div class="post-body">
                        ...
                        <div class="entry-header">
                            <h2 class="entry-title">
                                ...
                                <p>Partners: <?php echo $fet['partners'] ?></p>
                                <p>Address: <?php echo $fet['address'] ?></p>
                            </h2>
                        </div>

                        <div class="schedule-listing-btn">
                            <a href="booking1.php?id=<?php echo $fet['id'] ?>" class="btn ">
                                Hire Now!</a>
                        </div>
