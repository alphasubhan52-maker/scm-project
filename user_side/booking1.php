...
if (isset($_POST['submit'])) {
    ...
    if (mysqli_num_rows($urun) > 0) {
        ...
        '$type','$third','$workertitle','$workername','$workerphone','$workeremail')";
            ...
            if ($run) {
                echo "<script>alert('Planner Booked successfully!');</script>";
                echo "<script>
                setTimeout(function(){ window.location.href = './planner1view.php';},1000);
                </script>";
            } else {
            ...
            if ($run) {
                ...
                try {
                    ...
                    $mail->isHTML(true);
                    $mail->Subject = 'Booking Confirmation -' . $workername . 'Event Organizer';
                    $mail->Body = "
        ...
        <div class="row mx-auto justify-content-center">
            <div class="col-lg-8 mx-auto">
                <form id="contact-form" class="contact-form" action="" method="post" enctype="multipart/form-data">
                    <?php
                    $gid = $_GET['id'];
                    $gsql = "SELECT*FROM `planner` WHERE `id`='$gid'";
                    ...
                    <div class="col-md-12">
                        <div class="form-group">
                            <label for="pname">Planner NAME</label>
                            <input type="text" class="form-control" id="pname" name="workername"
                                value="<?php echo $gfet['name'] ?>" readonly>
                        </div>
                    </div>
                    <div class="col-md-12">
                        <div class="form-group">
                            <label for="pphone">Planner Phone</label>
                            <input type="text" class="form-control" id="pphone" name="workerphone"
                                value="<?php echo $gfet['phone'] ?>" readonly>
                        </div>
                    </div>
                    <div class="col-md-12">
                        <div class="form-group">
                            <label for="pemail">Planner Email</label>
                            <input type="text" class="form-control" id="pemail" name="workeremail"
